...
function ShoppingCart() {
    ...
    return (
      <div>
        {/* below is the searchbar + ecommerce3*/}
        <div className="header">
            {/* for logo */}
            <div className="ecumenic left-align-text">
                <p>eCommerce3</p>
            </div>
            {/* to create search bar */}
            <div className="mx-auto search-bar"> {/* mx-auto, d-flex, and flex-grow-1 are used so that the search bar grows with the size
            of the website window and so that it stays in the middle */}
                <input type="text" className="search-input d-flex flex-grow-1" placeholder="Search..."/>
                <button className="search-button mx-1">Search</button>
            </div>
        </div>
      <br/>
